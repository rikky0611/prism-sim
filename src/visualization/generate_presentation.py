...
def create_presentation():
    ...
    add_bullet_slide(
        ...
        [
            ...
            "Cost Function: R = -c_int × interruptions - c_fail × failures",
    ...
    add_bullet_slide(
        ...
        [
            ...
            "Cost regimes: Varying c_int and c_fail ratios"
        ]
    )
    ...
    add_image_slide(
        prs,
        "Single Regime Results (Balanced: c_int=5, c_fail=12)",
    ...
    add_bullet_slide(
        ...
        [
            ...
            "Approach: Train on 5 regimes with varying c_fail/c_int ratios",
            "Parameters:",
    ...
    add_table_slide(
        ...
        ["Cost Regime", "Ratio (c_fail/c_int)", "RL Interventions", "Behavior"],
        [
